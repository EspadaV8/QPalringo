...
void salsa20_encrypt_bytes(salsa20_ctx *x,const uint8_t *m,u8 *c,uint32_t bytes)
{
...
void salsa20_decrypt_bytes(salsa20_ctx *x,const uint8_t *c,u8 *m,uint32_t bytes)
{
  salsa20_encrypt_bytes(x,c,m,bytes);
}

void salsa20_keystream_bytes(salsa20_ctx *x,uint8_t *stream,uint32_t bytes)
{
  uint32_t i;
